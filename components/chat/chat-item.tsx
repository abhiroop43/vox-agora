...
import { MembeRole, Member, Profile } from '@prisma/client';
...
const formSchema = z.object({
  content: z.string().trim().min(1, { message: 'Message is required.' }),
});
...
const ChatItem = ({
  ...
  const isAdmin = currentMember.role === MembeRole.ADMIN;
  const isModerator = currentMember.role === MembeRole.MODERATOR;
